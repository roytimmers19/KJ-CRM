            ...
            <div class="p-6 text-gray-900">
                <header>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __("Add a customer and it will be saved for you.") }}
                    </p>
                </header>
                ...
                <form wire:submit.prevent="save" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input wire:model="place" id="place" name="place" type="text" class="mt-1 block w-full" required autocomplete="city" />
